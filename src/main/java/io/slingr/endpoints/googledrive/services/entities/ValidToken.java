...
import io.slingr.endpoints.googledrive.services.GoogleDriveService;
...
public class ValidToken {
    ...
    private static final DateFormat DATE_FORMAT = new SimpleDateFormat(GoogleDriveService.EXPIRATION_TIME_FORMAT);
